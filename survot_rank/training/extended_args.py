...
def build_base_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dct_v315_lambda_rti_rank", type=float, default=0.0)
    parser.add_argument("--dct_v315_rti_rank_margin", type=float, default=0.02)
    parser.add_argument("--dct_v315_rti_rank_temperature", type=float, default=0.50)
    parser.add_argument("--dct_v315_ipcw_max_weight", type=float, default=10.0)
    parser.add_argument("--v316_lambda_mi", type=float, default=0.01)
    parser.add_argument("--v316_hidden_dim", type=int, default=256)
    parser.add_argument("--v316_profile_temp", type=float, default=1.0)
