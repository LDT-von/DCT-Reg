...
COMPAT_RUNTIME_DIR = RESEARCH_DIR / "legacy" / "slotspe_runtime"


def add_project_paths() -> None:
    """Make DCT compatibility modules importable from package entrypoints."""
    for path in (PROJECT_ROOT, COMMON_DIR, COMPAT_RUNTIME_DIR):
        value = str(path)
