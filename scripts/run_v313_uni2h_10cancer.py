#!/usr/bin/env python3
"""Run v3.13 (transport-aware reconstruction) on the remaining 4 cancers (brca/coadread/luad/stad) for the 10-cancer sweep as the
v3.10 10-cancer sweep, using the UNI2-h encoder and 5fold_uni2h splits.

Cancers: brca, coadread, luad, stad   completing the
set; use --cancers to filter.)
...
Usage:
    python3 scripts/run_v313_uni2h_10cancer.py --plan
    python3 scripts/run_v313_uni2h_10cancer.py --run --gpus 0 1
    python3 scripts/run_v313_uni2h_10cancer.py --run --gpus 0 1 --cancers skcm hnsc lusc kirc ucec
"""
...
LOG_BASE = "/data1/DCT-Reg/logs/v313_uni2h_10cancer"
DATASET_CSV_ROOT = "/data1/dataset_csv"

# Remaining 4 cancers to complete the 10-cancer sweep
