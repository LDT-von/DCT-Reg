#!/bin/bash
# ============================================================================
# Launch DCT v3.10 UNI2-h extension queue (4 missing cancers)
# 顺序: coadread → luad → stad → ucec, 每癌种 5 fold
# 输出: results/dct_v3.10_uni2h_extend/final/<cancer>/
# ============================================================================
...
echo "[$NAME] GPU: ${GPU:-0}"
echo "[$NAME] 队列: coadread → luad → stad → ucec, 每癌种 5 fold × 30 epoch"
echo "============================================================"

$PYTHON_BIN scripts/run_v310_uni2h_extend.py run \
    --data-root /data1/TCGA-UNI2-h-features \
